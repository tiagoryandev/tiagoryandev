...
export default function AboutMe() {
  return (
    <>
      <Head>
        <title>Sobre Mim - Tiago Ryan | Portfólio</title>
      </Head>
      <WindowPage>
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="w-full max-w-2xl text-sm font-thin text-zinc-100">
              &emsp;Olá, sou Tiago Ryan. Ingressei na programação aos 13-14
              anos, iniciando com o desenvolvimento de bots para Discord em
              JavaScript por cerca de dois anos. Posteriormente, direcionei meu
              foco para o desenvolvimento web, começando no backend com Node.js
              e posteriormente explorando o frontend com React.
            </p>
            <p className="w-full max-w-2xl text-sm font-thin text-zinc-100">
              &emsp;Essa jornada enriqueceu minhas habilidades técnicas e
              proporcionou uma compreensão abrangente do ciclo de
              desenvolvimento de software. Estou entusiasmado para continuar
              aprendendo e contribuindo para a comunidade.
            </p>
          </div>
