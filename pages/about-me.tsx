    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="w-full max-w-2xl text-sm font-thin text-zinc-100">
          ...
          explorando o frontend com React.
        </p>
        <p className="w-full max-w-2xl text-sm font-thin text-zinc-100">
          &emsp;Essa jornada enriqueceu minhas habilidades técnicas e
          proporcionou uma compreensão abrangente do ciclo de desenvolvimento de
          software. Estou entusiasmado para continuar aprendendo e contribuindo
          para a comunidade.
        </p>
      </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="relative ml-2 border-l-[1px] border-l-neutral-700 pl-4">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col">
                <h1 className="select-none text-zinc-100">BackEnd Developer</h1>
                <span className="select-none text-sm text-zinc-300">
